...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n // eslint-disable-line\r\n\r\ndocument.querySelector('.fa-angle-down').addEventListener('click', () => {\r\n  const todoData = document.querySelector('.newTodo').value;\r\n  if (todoData.trim() === '') {\r\n    return;\r\n  }\r\n  _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].push({ description: `${todoData}`, completed: false, index: _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].length });\r\n  localStorage.setItem('newTodo', JSON.stringify(_index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]));\r\n  window.location.reload();\r\n});\r\n\n\n//# sourceURL=webpack://set-up-webpack/./src/crud.js?");
