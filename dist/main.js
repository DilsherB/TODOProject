...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n // eslint-disable-line\n\nconst clearAll = document.querySelector('.clearAll');\nclearAll.addEventListener('click', () => {\n  const filteredData = _index_js__WEBPACK_IMPORTED_MODULE_0__.toDoTasks.filter((e) => e.completed === false);\n  localStorage.setItem('newTodo', JSON.stringify(filteredData));\n  window.location.reload();\n});\n\n//# sourceURL=webpack://set-up-webpack/./src/clearAll.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n // eslint-disable-line\n\nconst addItem = () => {\n  const todoData = document.querySelector('.newTodo').value;\n  if (todoData.trim() === '') {\n    return;\n  }\n  _index_js__WEBPACK_IMPORTED_MODULE_0__.toDoTasks.push({ description: `${todoData}`, completed: false, index: _index_js__WEBPACK_IMPORTED_MODULE_0__.toDoTasks.length + 1 });\n  localStorage.setItem('newTodo', JSON.stringify(_index_js__WEBPACK_IMPORTED_MODULE_0__.toDoTasks));\n  window.location.reload();\n  document.querySelector('.newTodo').value = '';\n};\n\ndocument.querySelector('.fa-angle-down').addEventListener('click', addItem);\ndocument.querySelector('.newTodo').addEventListener('keydown', (e) => {\n  if (e.code === 'Enter') { (addItem()); }\n});\n\n\n//# sourceURL=webpack://set-up-webpack/./src/crud.js?");
