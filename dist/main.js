...
eval("document.querySelector('.fa-angle-down').addEventListener('click', () => {\r\n    console.log(document.querySelector('.newTodo').innerHTML);\r\n    // localStorage.setItem('newTodo', document.querySelector('.newTodo').innerHTML);\r\n})\n\n//# sourceURL=webpack://set-up-webpack/./src/crud.js?");
